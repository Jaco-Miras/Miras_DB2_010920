/* Database Systems, Coronel/Morris // Type of SQL : MySQL *//*DROP Database SchoolRegistration;
...
CREATE TABLE "010920".CLASS
 (CLASS_CODE varchar(5),
 	...
 	CLASS_TIME varchar(20),CLASS_ROOM varchar(8),
 	PROF_NUM float(8));
INSERT INTO "010920".CLASS VALUES('10012','ACCT-211','1','MWF 8:00-8:50 a.m.','BUS311','105');
INSERT INTO "010920".CLASS VALUES('10013','ACCT-211','2','MWF 9:00-9:50 a.m.','BUS200','105');INSERT INTO "010920".CLASS VALUES('10014','ACCT-211','3','TTh 2:30-3:45 p.m.','BUS252','342');
...
CREATE TABLE "010920".COURSE (
	...
	CRS_CREDIT float(8));
INSERT INTO "010920".COURSE VALUES('ACCT-211','ACCT','Accounting I','3');INSERT INTO "010920".COURSE VALUES('ACCT-212','ACCT','Accounting II','3');
...
CREATE TABLE "010920".DEPARTMENT (DEPT_CODE varchar(10),
...
INSERT INTO "010920".DEPARTMENT VALUES('ECON/FIN','Economics/Finance','BUS','299','KLR 284, Box 63','3126');INSERT INTO "010920".DEPARTMENT VALUES('ENG','English','A&SCI','160','DRE 102, Box 223','1004');
...
CREATE TABLE "010920".EMPLOYEE (EMP_NUM int,
...
INSERT INTO "010920".ENROLL VALUES('10014','324257','B');INSERT INTO "010920".ENROLL VALUES('10018','321452','A');
INSERT INTO "010920".ENROLL VALUES('10018','324257','B');INSERT INTO "010920".ENROLL VALUES('10021','321452','C');
